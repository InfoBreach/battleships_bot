...
### Hunt Mode
Will be switch over after a successful hit.
Targets adjacent cells to locate the rest of the ship.
Will focus the next attack with a direction when multiple hits are aligned.
Will switch off if a ship is sunk.
...
## Contributers:
Tran Thien Khanh - 11525082
Nguyen Cong Gia Tri - 11525064
